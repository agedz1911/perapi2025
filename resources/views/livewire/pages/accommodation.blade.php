                ...
                <div class="">
                    <div class="mb-3 relative p-3">
                        ...
                        {!! $accommodation->tag ? '<span
                            class="absolute top-1 right-4 translate-y-5 bg-[#A93E89] rounded-xl text-white px-3 py-1">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="flex justify-center mb-3">
                            @for ($i = 1; $i <= 5; $i++) @if ($i <=$accommodation->hotel_star)
                                <i class="fa-solid fa-star text-[#F9C20A]"></i>
                                @else
                    ...
                    <div class="flex justify-evenly">
                        <a href="{{$accommodation->url ? $accommodation->url : 'javascript:void(0)'}}"
                            class="bg-purple-700 py-3 rounded-2xl font-semibold text-white hover:bg-[#F9C20A] ease-out duration-100 px-6">Book Now</a>
                        <a href="{{$accommodation->direction ? $accommodation->direction : 'javascript:void(0)'}}"
                            class="bg-transparent py-3 rounded-2xl font-semibold text-purple-900 hover:bg-[#F9C20A] ease-out duration-100 hover:text-white px-6"><i class="fa-solid fa-location-dot mx-1"></i>Direction</a>
                    </div>
                </div>
            </div>
            @endforeach
