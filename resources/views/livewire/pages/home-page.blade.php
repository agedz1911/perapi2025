<div class="w-full lg:w-11/12">
    ...
    <section class="pb-10 grid grid-cols-1 lg:grid-cols-2  px-3 gap-3">
        <div class="">
            <div>
            ...
            <div
                ...
                <div class="rounded-lg overflow-hidden h-[156px] md:h-[278px] bg-white dark:bg-gray-800">
                    ...
                    <div class="w-full absolute top-1 lg:top-4 text-center grid justify-items-center gap-0">
                        ...
                        <button
                            class="hover:text-amber-300 mt-2 text-white bg-gradient-to-br from-purple-800 to-[#92278F] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 md:px-10 lg:py-3.5 py-2.5 text-center uppercase">Join
                            Now !</button>
                    </div>
                </div>
            </div>
