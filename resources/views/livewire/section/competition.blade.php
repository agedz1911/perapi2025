    ...
    <section class="bg-competition bg-gray-50 py-24 ">
        <div class="">
            <div class= "m-auto text-center pb-7">
                <p class="mb-1 font-semibold text-gray-600 tracking-wide">28<sup>th</sup> InaPRAS</p>
            ...
            <div class="flex flex-wrap justify-evenly p-5">
                <div class="w-full max-w-md">
                    <div class="border border-gray-200 rounded-xl shadow-md text-center pt-4 pb-6">
                        <h5 class="p-4 text-gray-700 uppercase font-semibold tracking-wide text-xl hover:text-amber-500 hover:cursor-pointer">abstract Free paper</h5>
                        <a href="javascript:void(0)" class="text-blue">Read More <i
                        class="fa-solid fa-angles-right"></i></a>
                        <div class="p-5 pt-0 m-0 border-b"></div>
                ...
                <div class="w-full max-w-md">
                    <div class="border border-gray-200 rounded-xl shadow-md text-center pt-4 pb-7">
                        <h5 class="p-4 text-gray-700 uppercase font-semibold tracking-wide text-xl hover:text-amber-500 hover:cursor-pointer">Abstract E-Poster</h5>
                        <a href="javascript:void(0)" class="text-blue">Read More <i
                        class="fa-solid fa-angles-right"></i></a>
                        <div class="p-5 pt-0 m-0 border-b"></div>
                        <div class="pt-5 text-gray-500 tracking-wide">
