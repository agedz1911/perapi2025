...
<body>
    ...
    <button onclick="topFunction()" id="back-to-top"
        class="text-white bg-amber-400 hover:bg-amber-400 focus:ring-4 py-2 px-3 focus:outline-none focus:ring-amber-300 font-medium text-sm rounded-full text-center inline-flex items-center dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800 z-40 fixed right-5 md:right-10 bottom-10 over:-translate-y-1 hover:scale-105"><i
