<div class="flex flex-col items-center">
    ...
    <div class="stats stats-vertical lg:stats-horizontal shadow">
        ...
        <div class="stat">
            ...
            <div class="stat-desc hover:underline hover:text-primary"><a href="mailto:apras-inapras2026@pharma-pro.com ">apras-inapras2026@pharma-pro.com </a></div>
        </div>
        ...
        <div class="stat">
            ...
            <div class="stat-desc">
                <a class="hover:underline hover:text-primary" target="_blank" href="https://wa.me/+628111609822"> +62 811-1609 - 822 (Ririen) </a> <br>
